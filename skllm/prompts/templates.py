...
1. Identify the classes the provided search queries belong to with the highest probability. Important: if the search query does not explicitly refer to a concern, an ingredient or a feature, a product, advice or inspiration, do not infer classification but rather return *Unknown*.
