...
# Makeup dimensions
ZERO_SHOT_CLF_PROMPT_TEMPLATE_MU_DIM1 = common_part1.format(industry="makeup", items="beauty concerns") + common_part2.format(item="beauty concern", classification="*This query is not related to any beauty concern known*", example="lip gloss", example_value="This query is not related to any beauty concern known")
ZERO_SHOT_CLF_PROMPT_TEMPLATE_MU_DIM2 = common_part1.format(industry="makeup", items="ingredients or features") + common_part2.format(item="ingredient or feature", classification="*This query is not related to any makeup ingredient or feature known*", example="waterproof mascara", example_value="Waterproof")
ZERO_SHOT_CLF_PROMPT_TEMPLATE_MU_DIM3 = common_part1.format(industry="makeup", items="makeup products") + common_part2.format(item="makeup product", classification="*This query is not related to any makeup product known*", example="red lipstick", example_value="Lipstick")
ZERO_SHOT_CLF_PROMPT_TEMPLATE_MU_DIM4 = common_part1.format(industry="makeup", items="makeup advices or inspiration") + common_part2.format(item="makeup advice or inspiration", classification="*This query is not related to any makeup advice or inspiration known*", example="best red lipstick", example_value="Best")
