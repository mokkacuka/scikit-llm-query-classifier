...
class ZeroShotGPTClassifierDimension1(_BaseZeroShotGPTClassifier):
...
class ZeroShotGPTClassifierDimension2(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
...
class ZeroShotGPTClassifierDimension3(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
...
class ZeroShotGPTClassifierDimension4(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
